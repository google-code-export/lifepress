...
<div id="sidebar_container">
    ...
    <div id="explanation">
    <p><?php echo $this->lang->line('sidebar_explanation'); ?></p>
    </div>
    
    <h3><?php echo $this->lang->line('sidebar_popular_tags'); ?></h3>
    <ul class="tag_list">
    ...
    <h3><?php echo $this->lang->line('sidebar_search'); ?></h3>
    ...
    <p><input type="submit" value="<?php echo $this->lang->line('sidebar_search_submit'); ?>"/></p>
    </form>
